...
export async function logSearch(row) {
  ...
  try {
    const cols = [
      ...
      "summary_used", "summary_text", "summary_chars", "summary_model_actual", "summary_acts_used",
      "summary_prompt_tokens", "summary_candidates_tokens", "summary_thinking_tokens", "summary_total_tokens",
      "summary_finish_reason", "summary_elapsed_ms", "summary_error",
