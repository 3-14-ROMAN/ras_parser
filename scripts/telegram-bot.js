...
const SEARCH_HELP_TEXT =
  ...
  "\n" +
  "Пишите как юрист описывает фабулу дела:\n" +
  "• кто поставщик/покупатель\n" +
  "• что нарушено\n" +
  "• какие документы есть\n" +
  "• какой исход нужен\n" +
  "• какие доказательства важны\n" +
  "\n" +
  "<i>Бот не даёт юридическое заключение, а помогает найти релевантные акты и PDF.</i>";
...
const MAIN_KEYBOARD = {
  inline_keyboard: [
    ...
    [
      ...
      { text: "✅ Проверка",     callback_data: "ping" },
    ],
  ],
};
